...
protobuf_credentials :
	...
	protoc -I ./credentials/proto ./credentials/proto/payload.proto ./credentials/proto/common.proto ./credentials/proto/issuance.proto ./credentials/proto/degree.proto --js_out=import_style=commonjs,binary:./dev-scripts/protos/credentials